...
def insert_fork(fork: Fork) -> None:
    row = {
        ...
        "poster_path": fork.poster_path,
        "duration_ms": fork.duration_ms,
        "whisper_lang": fork.whisper_lang,
        "whisper_text": fork.whisper_text,
        "whisper_audio_path": fork.whisper_audio_path,
    ...
    try:
        client.insert(
            ...
            [[
                ...
                row["media_kind"], row["media_path"], row["poster_path"],
                row["duration_ms"], row["whisper_lang"], row["whisper_text"],
                row["whisper_audio_path"], row["vta_score"], row["loop_iterations"],
                row["generation_backend"], row["watermarked"], row["attribution"],
                row["rights_status"], row["dsg_json"], row["verdicts_json"],
                row["embedding"], datetime.utcnow(),
            ]],
            column_names=[
                "fork_id", "production_id", "parent_shot_id", "parent_scene_number",
                "title", "branch_label", "viewer_prompt", "composed_prompt", "origin",
                "media_kind", "media_path", "poster_path", "duration_ms", "whisper_lang",
                "whisper_text", "whisper_audio_path", "vta_score", "loop_iterations",
